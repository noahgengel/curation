...
# plt.xlabel(xlabel="\nTable Type", size=16)
# plt.title("Route Success Rate for {}".format(date), size = 18)
...
ax.set_title("Route Success Rates for {}".format(name_of_interest), size=14)
...
plt.title("Route Success Rate: {}".format(name_of_interest), size=15, y = 1.1)
...
plt.title("{} Route Success Rates Over Time".format(name_of_interest))
