...
# plt.xlabel(xlabel="\nTable Type", size=16)
# plt.title("Concept Success Rate for {}".format(date), size = 18)
# sns.despine(trim=True, left=True)

# # Now let's look at the metrics for particular sites with respect to concept success rate; this will allow us to send them the same information
...
plt.title("Concept Success Rate: {}".format(name_of_interest), size=15, y = 1.1)
