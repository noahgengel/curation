...
# # Now let's look at the metrics for particular sites with respect to measurement integration; this will allow us to send them the same information
...
plt.title("Measurement Integration: {}".format(name_of_interest), size=15, y = 1.1)
...
plt.title("{} Measurement Integration Rates Over Time".format(name_of_interest))
