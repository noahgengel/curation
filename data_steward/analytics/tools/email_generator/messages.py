...
introduction = \
    ...
    "In this e-mail, we will list out any errors that apply to your most recent submission (as of {date}) that fall below the DRC's standards for the data quality metrics. Similarly, we will provide you with a 'dashboard' that lists out these errors in an Excel format.\n\n" \
    "Finally, we will provide you with images that display data quality values for all {num_metrics} provided metrics, regardless of whether or not they meet the DRC's standards as noted here.\n\n"
